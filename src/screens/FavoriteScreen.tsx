...
const FavoriteScreen: React.FC<HomeProps> = ({ navigation }) => {
  ...
  return (
    <HomeContainer>
      <TopContainer>
        <TextInputStyled value={textSearch} placeholder={'Spiderman...'} onSubmitEditing={searchMoviesFavorite} onChangeText={onHandleChange.textSearch}/>
        <ButtonStyled onPress={searchMoviesFavorite}>
          <TextButtonStyled>Buscar</TextButtonStyled>
        </ButtonStyled>
      </TopContainer>
      {
